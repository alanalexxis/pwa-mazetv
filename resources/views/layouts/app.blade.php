...
<body class="absolute inset-0 -z-10 h-full w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem]"></body>
    <header>
        @include('partials.navbar') {{-- Incluirás la barra de navegación en todas las vistas --}}
    </header>
  ...
  <p class="block mb-4 text-sm text-center text-slate-500 md:mb-0 border-t border-slate-200 mt-4 pt-4">
    Copyright © {{ date('Y') }} &nbsp;
    <a href="https://material-tailwind.com/" target="_blank" rel="noreferrer">MazePWA</a>.
  </p>
  </footer>
</body>
</html>
